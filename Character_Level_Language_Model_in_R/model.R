model <- function(examples, char_to_ix, num_iterations = 70000, n_a = 50, dino_names = 7, vocab_size = 27) {
                ...
                for (j in 1:num_iterations){
                                        ...
                                        optimize.output = optimize(X, Y, a_prev, parameters, learning_rate = 0.005)
                                        ...
                                        if ((j %% 2000) == 0){ 
                                                             ...
                                                             for (name in 1:dino_names){
                                                                                       ...
                                                                                       for (k in 1:length(sampled)){cat(char_to_ix[ix == sampled[k]]$char)}
                                                                                       }
                                                             }
